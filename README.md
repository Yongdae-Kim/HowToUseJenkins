...
- #### Maven 설정
![jenkins_4](jenkins_4.png)
- #### Groovy 설정
![jenkins_5](jenkins_5.png)
- #### Gradle 설정
![jenkins_6](jenkins_6.png)
- #### Grails 설정
![jenkins_7](jenkins_7.png)
- #### Email 알림 설정
![jenkins_8](jenkins_8.png)
	- #### gmail 에서 SMTP service 제공
	- #### gmail 에서 '로그인 및 보안' 탭에서 보안수준 설정
	![jenkins_9](jenkins_9.png)
- #### FTP 서버 설정
![jenkins_10](jenkins_10.png)
 
---

## Maven 프로젝트 빌드 설정
 1. 프로젝트 생성 : item 이름 설정후, ***'Maven project'*** 클릭
![jenkins_11](jenkins_11.png)
 2. 프로젝트 설명 : 프로젝트 설명과 '오래된 빌드 삭제' 여부 선택
![jenkins_12](jenkins_12.png)
 3. 소스 코드 관리 : Git 소스 관리 프로젝트인 경우
![jenkins_13](jenkins_13.png)  
 4. 빌드 설정 : 매 30분마다 확인 후 변경 내용이 있으면 빌드
![jenkins_14](jenkins_14.png)
 5. 빌드 전에 실행할 내용 : 샘플 스크립트 파일을 실행
![jenkins_15](jenkins_15.png)
 6. 빌드 : pom.xml 의 경로 설정
![jenkins_16](jenkins_16.png)
 7. 빌드 후에 실행할 내용 : 그루비 문법 테스트
![jenkins_17](jenkins_17.png)
 8. Email 알림 설정
![jenkins_18](jenkins_18.png) 

---

### Gradle 프로젝트 빌드
#### 프로젝트 생성시 'FreeStyle Project' 선택 후 빌드 설정을 해줌
![jenkins_21](jenkins_21.png)

---

### Grails 프로젝트 빌드
#### 프로젝트 생성시 'FreeStyle Project' 선택 후 빌드 설정을 해줌
![jenkins_22](jenkins_22.png)

---

## 프로젝트 빌드
 - #### 빌드하기 : 'Build Now' 를 클릭
![jenkins_19](jenkins_19.png)
 - #### 빌드결과
![jenkins_20](jenkins_20.png)
...
## 추가 기능
 - ### 깃헙 에서 푸시 하면, 자동 빌드 하기
	...
	6. 빌드
	![jenkins_23](jenkins_23.png) 
 - ### FTP 서버로 war 파일 전송하기
 	1. 젠킨스 관리에서 플러그인(Publish Over FTP) 및 시스템 설정 후
 	2. 등록한 FTP 서버 선택
 	3. war 파일의 경로 설정
 	4. 빌드
 	![jenkins_24](jenkins_24.png)	
 ...
 ```
 	...
 	1. 젠킨스 관리에서 플러그인(Deploy to container plugin) 및 시스템 설정 후
 	2. 톰캣서버 버젼 선택
 	3. tomcat-users.xml 에 등록한 username, password 입력 후
 	4. ***Tomcat URL 설정***
 	5. 빌드
	![jenkins_25](jenkins_25.png)
 - ### 테스트 리포트 설정하기
 	```
 	<parent>
	...
	3. 빌드
 	...
 	![jenkins_26](jenkins_26.png)
 	![jenkins_27](jenkins_27.png)
